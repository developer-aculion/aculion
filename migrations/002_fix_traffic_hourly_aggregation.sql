-- Migration: 002_fix_traffic_hourly_aggregation.sql
-- Description: Parameterized robust hourly traffic aggregation function handling cumulative resets,
-- transient dropouts, complete camera identity partitioning, and IST timezone boundaries.

-- 1. Create parameterized process_traffic_hour(p_hour_start timestamptz)
...
-- 2. Create public.process_previous_hour() wrapper
